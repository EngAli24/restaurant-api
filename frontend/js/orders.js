    ...
    try {
        ...
        orders.forEach(order => {
            ...
            const actionButton = isDelivered 
                ? `<button class="locked-btn" disabled>مكتمل ✔️</button>` 
            ...
            ordersList.innerHTML += `
                <tr style="background-color: ${isDelivered ? '#f9f9f9' : 'white'}; opacity: ${isDelivered ? '0.8' : '1'};">
                    ...
                    <td><strong>${order.customerName}</strong><br><span style="color: #777; font-size: 0.9em;" dir="ltr">${order.customerPhone}</span></td>
